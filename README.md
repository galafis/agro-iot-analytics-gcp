...
**Agro Iot Analytics Gcp** — Agricultural IoT Data Analytics Platform with GCP integration - Smart farming and crop analytics

Total source lines: **282** across **2** files in **1** language.
...
# Run the container
docker run -p 8000:8000 agro-iot-analytics-gcp
```
...
Total de linhas de código: **282** em **2** arquivos em **1** linguagem.
